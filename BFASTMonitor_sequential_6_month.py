...
def do_bfast_monitor_6_month_sequential(model, starts, ends, data, dates, output, name, sub):
    ...
    for period in enumerate(starts):
        ...
        assemble_results(model, rows, cols, data2, dates2, period[1][0],
                         ends[period[0]], output, name, sub)
...
def main():
    ...
    output_prejoin: str = parameters_dict['output_prejoin']
    prefix: str = parameters_dict['prefix']

    index: str = parameters_dict['index']
