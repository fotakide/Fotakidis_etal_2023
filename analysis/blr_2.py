...
ax[0].title.set_text(f'{index_str} - Receiver operating characteristic')
...
ax[1].axvline(final.iloc[0].x, color="r", ls="-.", lw=0.2)
ax[1].axhline(final.iloc[0].proba, color="r", ls="-.", lw=0.2)
ax[1].axvline(final50.iloc[0].x, color="k", ls=":", lw=0.2)
ax[1].axhline(0.5, color="k", ls=":", lw=0.2)
plt.show()